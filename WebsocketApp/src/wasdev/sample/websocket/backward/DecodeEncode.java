...
@ServerEndpoint(value = "/DecodeEncodeBackward", decoders = { wasdev.sample.websocket.coders.DecoderOne.class }, encoders = { wasdev.sample.websocket.coders.EncoderOne.class })
    ...
    public void decodeTextSendBackEncodedText(FormatIn decodedObject) {
        ...
        try {
            if (message.equals("STOP")) {
                ...
                currentSession.getBasicRemote().sendText("ok, DecodeEncode stop");
