 ...
 */
package wasdev.sample.websocket.listenerEndpoint;
...
public class ListenerEndpointConfig implements ServerEndpointConfig {
    ...
    String uriPath = "/listenerEndpoint";

    public ListenerEndpointConfig() {
        // no-arg constructor
    }

    @Override
    public Class<?> getEndpointClass() {
        return ListenerEndpoint.class;
    }
